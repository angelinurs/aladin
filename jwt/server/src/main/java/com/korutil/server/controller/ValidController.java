...
public class ValidController {
    ...
    @PostMapping("/email")
    public CommonApiResponse<Boolean> isValidEmail(@RequestParam String email) {
        return
